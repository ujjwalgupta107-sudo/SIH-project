...
class Location(BaseModel): latitude:float=Field(ge=-90,le=90); longitude:float=Field(ge=-180,le=180); address:str=Field(min_length=2,max_length=500)
...
class IncidentCreate(BaseModel): type:str=Field(min_length=2,max_length=100); description:str=Field(min_length=3,max_length=4000); location:Location; media_urls:list[str]=[]; ai_analysis:AIAnalysis|None=None
